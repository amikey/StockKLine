...
-(void)drawBoxWithKline{
    ...
    kline = [[lines alloc] initWithFrame:CGRectMake(allinePositionx, 0, mainboxView.frame.size.width, mainboxView.frame.size.height)];
...
-(void)drawMAWithIndex:(int)index andColor:(NSString*)color{
    ...
    averageline = [[lines alloc] initWithFrame:CGRectMake(allinePositionx, 0, mainboxView.frame.size.width, mainboxView.frame.size.height)];
